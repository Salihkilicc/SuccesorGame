// @orphan-ok production moved inside ProductDetailModal (features/products/components/ProductModals.tsx)
...
const styles = StyleSheet.create({
    ...
    infoBox: { gap: 4 },
    hint: { fontSize: 11, color: '#C8C0EF', textAlign: 'center', fontStyle: 'italic' },
