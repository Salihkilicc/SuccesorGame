...
const styles = StyleSheet.create({
    ...
    container: {
        ...
        backgroundColor: '#0F0E0D', borderRadius: 20, padding: 20,
        borderWidth: 1, borderColor: '#E9B8C9',
    },
    titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 },
    title: { fontSize: 22, fontWeight: '800', color: '#FFF' },
    closeBtn: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#181614', alignItems: 'center', justifyContent: 'center' },
    closeText: { color: '#8A807B', fontSize: 16, fontWeight: '700' },

    controlCard: { backgroundColor: '#181614', borderRadius: 12, padding: 14, marginBottom: 12 },
    controlRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
    controlLabel: { fontSize: 12, color: '#8A807B', fontWeight: '600' },
    ...
    demandCard: { backgroundColor: '#0F0E0D', borderRadius: 12, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#E3A857' },
    demandTag: { fontSize: 10, color: '#E3A857', fontWeight: '800', letterSpacing: 1, marginBottom: 6 },
    demandBody: { fontSize: 12, color: '#EDE8E4', lineHeight: 18, fontStyle: 'italic' },
    demandPrivate: { fontSize: 10, color: '#5FB37A', marginTop: 6, lineHeight: 15 },
    demandDue: { fontSize: 10, color: '#8A807B', marginTop: 6, fontWeight: '700' },

    dangerCard: { backgroundColor: '#0F0E0D', borderRadius: 12, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#E06B6B' },
    ...
    tab: { flex: 1, padding: 10, borderRadius: 10, backgroundColor: '#181614', alignItems: 'center' },
    tabActive: { backgroundColor: '#E9B8C9' },
    tabText: { fontSize: 12, color: '#8A807B', fontWeight: '700' },
    tabTextActive: { color: '#000' },

    body: { flexGrow: 0, flexShrink: 1 },

    memberCard: { backgroundColor: '#181614', borderRadius: 12, padding: 14, marginBottom: 10 },
    memberTop: { flexDirection: 'row', alignItems: 'center' },
    memberName: { fontSize: 15, color: '#FFF', fontWeight: '700' },
    memberTrait: { fontSize: 11, color: '#8A807B', marginTop: 2 },
    memberRel: { fontSize: 9, color: '#5992C6', marginTop: 2 },
    memberTrust: { fontSize: 20, fontWeight: '800' },
    trustBarBg: { height: 5, backgroundColor: '#0F0E0D', borderRadius: 3, marginTop: 10, overflow: 'hidden' },
    trustBarFill: { height: '100%', borderRadius: 3 },
    promiseNote: { fontSize: 11, color: '#E9B8C9', marginTop: 8 },
    actionRow: { flexDirection: 'row', gap: 8, marginTop: 8 },
    openMemberBtn: { flex: 1, paddingVertical: 10, borderRadius: 10, alignItems: 'center', backgroundColor: '#0F0E0D', borderWidth: 1, borderColor: '#E3A857' },
    openMemberText: { color: '#E3A857', fontSize: 12, fontWeight: '700' },
    lobbyBtn: { flex: 1, padding: 10, borderRadius: 10, backgroundColor: '#0F0E0D', alignItems: 'center' },
    lobbyBtnDone: { opacity: 0.4 },
    lobbyText: { fontSize: 12, color: '#E9B8C9', fontWeight: '700' },

    floatCard: { backgroundColor: '#0F0E0D', borderRadius: 12, padding: 14, marginTop: 4 },
    floatTitle: { fontSize: 13, color: '#FFF', fontWeight: '700', marginBottom: 4 },
    floatBody: { fontSize: 11, color: '#8A807B', lineHeight: 16 },

    voteCard: { backgroundColor: '#181614', borderRadius: 12, padding: 14, marginBottom: 12 },
    ...
    voteReason: { fontSize: 11, color: '#8A807B' },

    logRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#181614' },
    logLabel: { fontSize: 12, color: '#FFF' },
    logEffect: { fontSize: 11, color: '#8A807B', marginTop: 2 },
    emptyLog: { fontSize: 12, color: '#8A807B', textAlign: 'center', paddingVertical: 24 },
});
