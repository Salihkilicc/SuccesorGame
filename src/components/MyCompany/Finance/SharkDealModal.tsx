...
const styles = StyleSheet.create({
    activeLoanCard: { backgroundColor: '#31241F', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    activeLoanTitle: { color: '#E9B8C9', fontWeight: '800', fontSize: 13, marginBottom: 4 },
    activeLoanBody: { color: '#E9B8C9', fontSize: 11, lineHeight: 16, marginBottom: 10 },
    repayBtn: { backgroundColor: '#5992C6', borderRadius: 10, paddingVertical: 11, alignItems: 'center' },
    repayBtnDisabled: { backgroundColor: '#533D35' },
    repayBtnText: { color: '#31241F', fontWeight: '800', fontSize: 13 },
    amountCard: { backgroundColor: '#42312A', borderRadius: 12, padding: 16 },
    ...
    amountChip: { flex: 1, padding: 8, borderRadius: 8, backgroundColor: '#31241F', alignItems: 'center', borderWidth: 1, borderColor: 'transparent' },
    ...
    termsCard: { backgroundColor: '#31241F', borderRadius: 12, padding: 16, gap: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    ...
    termBad: { fontSize: 12, color: '#E9B8C9', fontWeight: '700' },
    header: {
        alignItems: 'center',
        marginBottom: 24,
        paddingBottom: 20,
