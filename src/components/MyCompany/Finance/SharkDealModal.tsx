...
const styles = StyleSheet.create({
    activeLoanCard: { backgroundColor: '#422B71', borderRadius: 12, padding: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    ...
    repayBtnDisabled: { backgroundColor: '#422B71' },
    repayBtnText: { color: '#FFFFFF', fontWeight: '800', fontSize: 13 },
    amountCard: { backgroundColor: '#281F50', borderRadius: 12, padding: 16 },
    ...
    amountChip: { flex: 1, padding: 8, borderRadius: 8, backgroundColor: '#422B71', alignItems: 'center', borderWidth: 1, borderColor: 'transparent' },
    ...
    termsCard: { backgroundColor: '#422B71', borderRadius: 12, padding: 16, gap: 10, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
