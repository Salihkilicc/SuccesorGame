        ...
        <View style={disabled && styles.disabled}>
            ...
            <View style={styles.track}>
                ...
                <View
                    style={[
                        styles.fill,
                        { width: `${fillPct}%`, backgroundColor: overSoft ? '#FFB74D' : fillColor },
                    ]}
                />
                {markers.map((m, i) => (
                    <View
...
const styles = StyleSheet.create({
    ...
    unit: { color: '#6E6E6E', fontSize: 11, marginBottom: 4 },
    max: { color: '#6E6E6E', fontSize: 11, fontWeight: '700', marginBottom: 4 },
    ...
    scale: { color: '#6E6E6E', fontSize: 9.5, marginTop: 6 },
    ...
    pctText: { color: '#8A8A8A', fontSize: 10.5, fontWeight: '700' },
    pctTextActive: { color: '#4CAF50' },
    pctTextAccent: { color: '#7FB3FF' },
});
