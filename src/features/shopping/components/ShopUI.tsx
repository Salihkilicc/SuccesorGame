...
const styles = StyleSheet.create({
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.md, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#3C2D29', backgroundColor: '#000000' },
    backButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#000000', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#3C2D29' },
    backButtonPressed: { backgroundColor: '#000000', transform: [{ scale: 0.95 }] },
    ...
    shopCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#000000', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: '#3C2D29', marginBottom: theme.spacing.sm },
    shopCardPressed: { backgroundColor: '#000000', transform: [{ scale: 0.98 }] },
    shopIconContainer: { width: 48, height: 48, borderRadius: theme.radius.sm, backgroundColor: '#000000', alignItems: 'center', justifyContent: 'center', marginRight: theme.spacing.md },
    ...
    itemCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#000000', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: '#3C2D29' },
    ...
    ownedButton: { backgroundColor: '#000000', borderWidth: 1, borderColor: '#3C2D29' },
