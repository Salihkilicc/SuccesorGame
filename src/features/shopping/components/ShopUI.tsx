...
const styles = StyleSheet.create({
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.md, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#3E2723', backgroundColor: '#0A1128' },
    backButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#0A1128', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#3E2723' },
    backButtonPressed: { backgroundColor: '#0A1128', transform: [{ scale: 0.95 }] },
    ...
    shopCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0A1128', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: '#3E2723', marginBottom: theme.spacing.sm },
    shopCardPressed: { backgroundColor: '#0A1128', transform: [{ scale: 0.98 }] },
    shopIconContainer: { width: 48, height: 48, borderRadius: theme.radius.sm, backgroundColor: '#0A1128', alignItems: 'center', justifyContent: 'center', marginRight: theme.spacing.md },
    ...
    itemCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#0A1128', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: '#3E2723' },
    ...
    itemPrice: { color: '#E60000', fontSize: theme.typography.body, fontWeight: '700', marginTop: 2 },
    buyButton: { backgroundColor: '#E60000', paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.sm, borderRadius: theme.radius.sm, minWidth: 80, alignItems: 'center' },
    ...
    ownedButton: { backgroundColor: '#0A1128', borderWidth: 1, borderColor: '#3E2723' },
