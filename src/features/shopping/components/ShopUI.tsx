...
const styles = StyleSheet.create({
    header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.md, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: 'rgba(255,255,255,0.06)', backgroundColor: '#020626' },
    backButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#020626', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    backButtonPressed: { backgroundColor: '#020626', transform: [{ scale: 0.95 }] },
    ...
    shopCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#020626', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(255,255,255,0.06)', marginBottom: theme.spacing.sm },
    shopCardPressed: { backgroundColor: '#020626', transform: [{ scale: 0.98 }] },
    shopIconContainer: { width: 48, height: 48, borderRadius: theme.radius.sm, backgroundColor: '#020626', alignItems: 'center', justifyContent: 'center', marginRight: theme.spacing.md },
    ...
    itemCard: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#020626', padding: theme.spacing.md, borderRadius: theme.radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(255,255,255,0.06)' },
    ...
    buyButton: { backgroundColor: '#0B0635', paddingHorizontal: theme.spacing.lg, paddingVertical: theme.spacing.sm, borderRadius: theme.radius.sm, minWidth: 80, alignItems: 'center' },
    ...
    ownedButton: { backgroundColor: '#020626', borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
