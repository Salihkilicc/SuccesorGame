...
const styles = StyleSheet.create({
    ...
    errorText: { color: '#C734CA', fontSize: 16, marginBottom: 20 },
    goBackBtn: { padding: 10, backgroundColor: '#0B0635', borderRadius: 8, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
