...
const styles = StyleSheet.create({
  ...
  tabActive: { backgroundColor: 'rgba(5,168,246,0.15)', borderColor: 'rgba(255,255,255,0.08)' },
  tabLabel: { color: 'rgba(255,255,255,0.48)', fontWeight: '700', fontSize: theme.typography.caption + 1 },
  tabLabelActive: { color: theme.colors.textMuted },
  ...
  subTabActive: { backgroundColor: 'rgba(5,168,246,0.2)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  tabSection: {
  ...
  secondaryButton: { backgroundColor: 'rgba(5,168,246,0.12)', paddingVertical: theme.spacing.md, borderRadius: 12, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  secondaryButtonPressed: { backgroundColor: 'rgba(5,168,246,0.2)', transform: [{ scale: 0.98 }] },
  secondaryButtonText: { color: theme.colors.textPrimary, fontWeight: '700', fontSize: theme.typography.body },
  ...
  seeInvestmentsButton: { flex: 1, backgroundColor: 'rgba(5,168,246,0.12)', borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.08)', borderRadius: 12, paddingVertical: theme.spacing.sm, alignItems: 'center' },
  seeInvestmentsButtonPressed: { backgroundColor: 'rgba(5,168,246,0.22)', transform: [{ scale: 0.98 }] },
  seeInvestmentsButtonText: { color: theme.colors.textPrimary, fontWeight: '800', fontSize: theme.typography.body },
  ...
  liquidateButtonPressed: { backgroundColor: 'rgba(5,168,246,0.1)', transform: [{ scale: 0.98 }] },
  liquidateButtonText: { color: theme.colors.textPrimary, fontWeight: '700', fontSize: theme.typography.body },
});