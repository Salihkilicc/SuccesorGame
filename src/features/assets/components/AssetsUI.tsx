        ...
        <View style={{ gap: theme.spacing.xs, marginTop: theme.spacing.lg }}>
            ...
            {items.map((item, index) => (
                <View key={index} style={styles.breakdownRow}>
                    ...
                    <Text style={[styles.breakdownValue, { color: isIncome ? theme.colors.success : '#EDE8E4' }]}>
...
const styles = StyleSheet.create({
    ...
    summaryLabel: { color: '#8A807B', fontSize: 12, letterSpacing: 0.4, textTransform: 'uppercase', marginBottom: 2 },
    summaryValue: { color: '#EDE8E4', fontSize: 20, fontWeight: '800', letterSpacing: 0.5 },
    ...
    sectionHeader: { fontSize: 13, fontWeight: '700', color: '#8A807B', textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 4 },
    ...
    breakdownLabel: { fontSize: 14, color: '#EDE8E4' },
