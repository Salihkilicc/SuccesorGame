...
const MartialArtsView = ({
    ...
    const getBeltColor = (level: number) => {
        const colors = ['#FF8A8A', '#FF8A8A', '#FF8A8A', '#FF8A8A', '#FF8A8A', '#FF8A8A', '#1C242C'];
        return colors[level] || '#FF8A8A';
    };
...
const styles = StyleSheet.create({
    ...
    beltLabel: { color: theme.colors.textMuted, fontSize: 12, letterSpacing: 1 },
