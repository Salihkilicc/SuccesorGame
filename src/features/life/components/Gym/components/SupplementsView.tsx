...
const styles = StyleSheet.create({
    ...
    subSubtitle: { color: '#E9B8C9', textAlign: 'center', marginBottom: 20 },
    list: { gap: 12 },
    supplementCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0F0E0D', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#E9B8C9' },
    supplementIcon: { fontSize: 24, marginRight: 12 },
    supplementName: { color: '#EDE8E4', fontWeight: '700' },
    supplementEffect: { color: '#E3A857', fontSize: 12 },
