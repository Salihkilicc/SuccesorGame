...
const styles = StyleSheet.create({
    ...
    list: { gap: 12 },
    trainerCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#020626', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    activeCard: { borderColor: 'rgba(255,255,255,0.08)', backgroundColor: '#020626' },
    iconBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#020626', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
