...
const styles = StyleSheet.create({
    ...
    list: { gap: 12 },
    trainerCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#000000', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#E9B8C9' },
    activeCard: { borderColor: '#E3A857', backgroundColor: '#000000' },
    iconBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#000000', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
