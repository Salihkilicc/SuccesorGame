...
const styles = StyleSheet.create({
    ...
    list: { gap: 12 },
    trainerCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0F0E0D', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: '#E9B8C9' },
    activeCard: { borderColor: '#E3A857', backgroundColor: '#0F0E0D' },
    iconBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#0F0E0D', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    trainerIcon: { fontSize: 20 },
    trainerInfo: { flex: 1 },
    trainerName: { color: '#EDE8E4', fontWeight: '700', fontSize: 16 },
    trainerRole: { color: '#E9B8C9', fontSize: 12 },
    trainerBonus: { color: '#E3A857', fontSize: 12, marginTop: 2 },
    trainerPrice: { color: '#EDE8E4', fontWeight: '700', fontSize: 16 },
    activeText: { color: '#E3A857' },
