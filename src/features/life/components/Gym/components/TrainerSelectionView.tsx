...
const styles = StyleSheet.create({
    ...
    list: { gap: 12 },
    trainerCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0B0635', padding: 16, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
    activeCard: { borderColor: 'rgba(255,255,255,0.08)', backgroundColor: '#0B0635' },
    iconBox: { width: 40, height: 40, borderRadius: 20, backgroundColor: '#0B0635', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    trainerIcon: { fontSize: 20 },
    trainerInfo: { flex: 1 },
    trainerName: { color: '#FFFFFF', fontWeight: '700', fontSize: 16 },
    trainerRole: { color: '#C734CA', fontSize: 12 },
    trainerBonus: { color: '#C734CA', fontSize: 12, marginTop: 2 },
    trainerPrice: { color: '#FFFFFF', fontWeight: '700', fontSize: 16 },
    activeText: { color: '#C734CA' },
