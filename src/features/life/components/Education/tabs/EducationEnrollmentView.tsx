...
const styles = StyleSheet.create({
    ...
    backBtn: {
        ...
        backgroundColor: 'rgba(89,146,198,0.5)',
        borderRadius: 20,
        borderWidth: 1,
    ...
    tab: {
        ...
        borderWidth: 1,
        borderColor: 'rgba(89,146,198,0.2)',
    },
    activeTab: {
    ...
    statusSection: {
        marginBottom: 0,
        borderBottomWidth: 1,
        borderBottomColor: 'rgba(233,184,201,0.3)',
    },
    warningBanner: {
    ...
    cardHeader: {
        marginBottom: 16,
        borderBottomWidth: 1,
        borderBottomColor: 'rgba(89,146,198,0.1)',
        paddingBottom: 12,
    },
    titleRow: {
        flexDirection: 'row',
    ...
    enrollButton: {
        ...
        paddingVertical: 14,
        alignItems: 'center',
        shadowColor: 'rgba(233,184,201,0.4)',
        shadowOffset: { width: 0, height: 4 },
        shadowOpacity: 1,
        shadowRadius: 8,
    },
