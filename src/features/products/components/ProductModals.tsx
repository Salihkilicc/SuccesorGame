...
const styles = StyleSheet.create({
    ...
    content: { backgroundColor: '#0B0635', borderRadius: 16, padding: 20, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    ...
    barBg: { height: 6, backgroundColor: '#0B0635', borderRadius: 3, marginBottom: 12 },
    ...
    partnerChipActive: { borderColor: 'rgba(255,255,255,0.08)', backgroundColor: '#0B0635' },
