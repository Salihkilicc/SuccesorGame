...
const styles = StyleSheet.create({
  ...
  activeProfit: { color: '#B28C96', fontSize: 12 },
  ...
  lockedCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#473633', padding: 16, borderRadius: 12, opacity: 0.8 },
  iconBox: { width: 48, height: 48, backgroundColor: '#000000', borderRadius: 10, alignItems: 'center', justifyContent: 'center', marginRight: 16 },
