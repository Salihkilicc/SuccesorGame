...
const styles = StyleSheet.create({
  ...
  activeProfit: { color: '#8A807B', fontSize: 12 },
  ...
  lockedCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#201D1C', padding: 16, borderRadius: 12, opacity: 0.8 },
  iconBox: { width: 48, height: 48, backgroundColor: '#0F0E0D', borderRadius: 10, alignItems: 'center', justifyContent: 'center', marginRight: 16 },
