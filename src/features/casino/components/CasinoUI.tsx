...
const styles = StyleSheet.create({
    ...
    repValueText: { color: theme.colors.textPrimary, fontSize: theme.typography.caption, fontWeight: '700' },
    ...
    playButtonText: { color: theme.colors.textPrimary, fontWeight: '700', fontSize: 12 },
    ...
    slotCta: { color: theme.colors.textPrimary, fontSize: 12, fontWeight: '700', marginTop: 4 },
    ...
    highRollerNote: { color: theme.colors.textPrimary, fontSize: 12, fontWeight: '600' },
