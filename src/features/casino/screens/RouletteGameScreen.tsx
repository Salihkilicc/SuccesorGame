...
const RouletteGameScreen = () => {
  ...
  const renderBetButton = (type: BetType, label: string) => {
    ...
    const color = active ? currentLocation.theme.primary : '#523F3E';
    ...
    return (
      <Pressable
        ...
        style={({ pressed }) => [
          styles.betButton,
          { borderColor: active ? currentLocation.theme.primary : '#614A4B', backgroundColor: active ? 'rgba(255,255,255,0.1)' : 'transparent' },
...
const styles = StyleSheet.create({
  ...
  tableTitle: { color: '#B28C96', fontSize: 12, fontWeight: '700', letterSpacing: 1, textAlign: 'center' },
