...
export const FACILITY_TIERS: FacilityTier[] = [
    {
        ...
        brandFloor: 5,
        qualityCeiling: 2,
        description: t('data.capacity.aRentedFloorWithHand'),
    },
    {
        level: 2,
        name: t('data.capacity.smallAssemblyLine'),
        capacity: 7_350,
        crew: 32,
        ...
        brandFloor: 8,
        qualityCeiling: 2,
        description: t('data.capacity.oneRealLineWithA'),
    },
    {
        level: 3,
        name: t('data.capacity.assemblyPlant'),
        capacity: 12_000,
        crew: 48,
        ...
        brandFloor: 10,
        qualityCeiling: 3,
        description: t('data.capacity.aProperPlantWithShifts'),
    },
    {
        level: 4,
        name: t('data.capacity.expandedPlant'),
        capacity: 19_600,
        crew: 72,
        ...
        brandFloor: 12,
        qualityCeiling: 3,
        description: t('data.capacity.secondHallSecondShiftScrap'),
    },
    {
        level: 5,
        name: t('data.capacity.regionalPlant'),
        capacity: 32_000,
        crew: 108,
        ...
        brandFloor: 14,
        qualityCeiling: 4,
        description: t('data.capacity.suppliesAWholeRegionOn'),
    },
    {
        level: 6,
        name: t('data.capacity.dualLinePlant'),
        capacity: 52_200,
        crew: 160,
        ...
        brandFloor: 16,
        qualityCeiling: 4,
        description: t('data.capacity.twoIndependentLinesOneCan'),
    },
    {
        level: 7,
        name: t('data.capacity.automatedPlant'),
        capacity: 85_300,
        crew: 238,
        ...
        brandFloor: 18,
        qualityCeiling: 5,
        description: t('data.capacity.robotsOnTheFloorFewer'),
    },
    {
        level: 8,
        name: t('data.capacity.advancedFab'),
        capacity: 139_000,
        crew: 354,
        ...
        brandFloor: 20,
        qualityCeiling: 5,
        description: t('data.capacity.cleanRoomsAndTolerancesYour'),
    },
    {
        level: 9,
        name: t('data.capacity.megafactory'),
        capacity: 227_000,
        crew: 526,
        ...
        brandFloor: 23,
        qualityCeiling: 6,
        description: t('data.capacity.theSitePeopleFlyIn'),
    },
    {
        level: 10,
        name: t('data.capacity.integratedComplex'),
        capacity: 371_000,
        crew: 784,
        ...
        brandFloor: 25,
        qualityCeiling: 6,
        description: t('data.capacity.componentsMadeInHouseYou'),
    },
    {
        level: 11,
        name: t('data.capacity.continentalHub'),
        capacity: 606_000,
        crew: 1_170,
        ...
        brandFloor: 28,
        qualityCeiling: 7,
        description: t('data.capacity.severalPlantsRunAsOne'),
    },
    {
        level: 12,
        name: t('data.capacity.precisionFoundry'),
        capacity: 990_000,
        crew: 1_740,
        ...
        brandFloor: 30,
        qualityCeiling: 7,
        description: t('data.capacity.tolerancesMeasuredInMicronsThis'),
    },
    {
        level: 13,
        name: t('data.capacity.roboticMegaline'),
        capacity: 1_620_000,
        crew: 2_590,
        ...
        brandFloor: 33,
        qualityCeiling: 8,
        description: t('data.capacity.linesThatReconfigureThemselvesBetween'),
    },
    {
        level: 14,
        name: t('data.capacity.industrialCampus'),
        capacity: 2_640_000,
        crew: 3_840,
        ...
        brandFloor: 35,
        qualityCeiling: 8,
        description: t('data.capacity.aCityBuiltAroundProduction'),
    },
    {
        level: 15,
        name: t('data.capacity.nationalNetwork'),
        capacity: 4_310_000,
        crew: 5_720,
        ...
        brandFloor: 38,
        qualityCeiling: 9,
        description: t('data.capacity.everyMajorRegionHasA'),
    },
    {
        level: 16,
        name: t('data.capacity.adaptiveGigaplant'),
        capacity: 7_030_000,
        crew: 8_500,
        ...
        brandFloor: 40,
        qualityCeiling: 9,
        description: t('data.capacity.aPlantThatRetoolsItself'),
    },
    {
        level: 17,
        name: t('data.capacity.autonomousComplex'),
        capacity: 11_500_000,
        crew: 12_700,
        ...
        brandFloor: 43,
        qualityCeiling: 10,
        description: t('data.capacity.runsLightsOutPeopleSupervise'),
    },
    {
        level: 18,
        name: t('data.capacity.continentalNetwork'),
        capacity: 18_800_000,
        crew: 18_900,
        ...
        brandFloor: 45,
        qualityCeiling: 10,
        description: t('data.capacity.continentalNetworksLinkedIntoOne'),
    },
    {
        level: 19,
        name: t('data.capacity.globalNetwork'),
        capacity: 30_600_000,
        crew: 28_000,
        ...
        brandFloor: 48,
        qualityCeiling: 10,
        description: t('data.capacity.everythingEverywhereAsASingle'),
    },
    {
        level: 20,
        name: t('data.capacity.planetaryIndustrialBase'),
        capacity: 50_000_000,
        crew: 41_700,
        ...
        brandFloor: 50,
        qualityCeiling: 10,
        description: t('data.capacity.theIndustrialBaseACountry'),
    },
];
