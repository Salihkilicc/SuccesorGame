...
export const FACILITY_TIERS: FacilityTier[] = [
    {
        ...
        brandFloor: 5,
        qualityCeiling: 2,
        description: 'A rented floor with hand-assembly benches. It works, but nobody writes about it.',
    },
    {
        level: 2,
        name: 'Small Assembly Line',
        capacity: 7_350,
        crew: 32,
        ...
        brandFloor: 8,
        qualityCeiling: 2,
        description: 'One real line with a conveyor. Output stops depending on who showed up today.',
    },
    {
        level: 3,
        name: 'Assembly Plant',
        ...
        brandFloor: 10,
        qualityCeiling: 3,
        description: 'A proper plant with shifts and a quality desk. Buyers will now take a meeting.',
    },
    {
        level: 4,
        name: 'Expanded Plant',
        ...
        brandFloor: 12,
        qualityCeiling: 3,
        description: 'Second hall, second shift. Scrap rates finally start looking respectable.',
    },
    {
        level: 5,
        name: 'Regional Plant',
        ...
        brandFloor: 14,
        qualityCeiling: 4,
        description: 'Supplies a whole region on its own. Unit cost drops below the industry line.',
    },
    {
        level: 6,
        name: 'Dual-Line Plant',
        capacity: 52_200,
        crew: 160,
        ...
        brandFloor: 16,
        qualityCeiling: 4,
        description: 'Two independent lines. One can retool while the other keeps shipping.',
    },
    {
        level: 7,
        name: 'Automated Plant',
        capacity: 85_300,
        crew: 238,
        ...
        brandFloor: 18,
        qualityCeiling: 5,
        description: 'Robots on the floor. Fewer hands per unit, far more capital per hand.',
    },
    {
        level: 8,
        name: 'Advanced Fab',
        ...
        brandFloor: 20,
        qualityCeiling: 5,
        description: 'Clean rooms and tolerances your competitors cannot match yet.',
    },
    {
        level: 9,
        name: 'Megafactory',
        ...
        brandFloor: 23,
        qualityCeiling: 6,
        description: 'The site people fly in to tour. Manufacturing has become part of the brand.',
    },
    {
        level: 10,
        ...
        brandFloor: 25,
        qualityCeiling: 6,
        description: 'Components made in-house. You no longer wait on anyone else’s schedule.',
    },
    {
        level: 11,
        ...
        brandFloor: 28,
        qualityCeiling: 7,
        description: 'Several plants run as one system across a continent. Logistics is now a science here.',
    },
    {
        level: 12,
        name: 'Precision Foundry',
        capacity: 990_000,
        crew: 1_740,
        ...
        brandFloor: 30,
        qualityCeiling: 7,
        description: 'Tolerances measured in microns. This is where the expensive categories become possible.',
    },
    {
        level: 13,
        name: 'Robotic Megaline',
        capacity: 1_620_000,
        crew: 2_590,
        ...
        brandFloor: 33,
        qualityCeiling: 8,
        description: 'Lines that reconfigure themselves between products. Changeovers stop costing you weeks.',
    },
    {
        level: 14,
        ...
        brandFloor: 35,
        qualityCeiling: 8,
        description: 'A city built around production. Housing, training, research — all of it yours.',
    },
    {
        level: 15,
        ...
        brandFloor: 38,
        qualityCeiling: 9,
        description: 'Every major region has a site, and they cover for each other.',
    },
    {
        level: 16,
        name: 'Adaptive Gigaplant',
        capacity: 7_030_000,
        crew: 8_500,
        ...
        brandFloor: 40,
        qualityCeiling: 9,
        description: 'A plant that retools itself for whatever the market wants next.',
    },
    {
        level: 17,
        name: 'Autonomous Complex',
        capacity: 11_500_000,
        crew: 12_700,
        ...
        brandFloor: 43,
        qualityCeiling: 10,
        description: 'Runs lights-out. People supervise; the plant decides.',
    },
    {
        level: 18,
        ...
        brandFloor: 45,
        qualityCeiling: 10,
        description: 'Continental networks linked into one balance sheet. Nobody else can quote your lead times.',
    },
    {
        level: 19,
        name: 'Global Network',
        ...
        brandFloor: 48,
        qualityCeiling: 10,
        description: 'Everything, everywhere, as a single production system.',
    },
    {
        level: 20,
        name: 'Planetary Industrial Base',
        capacity: 50_000_000,
        crew: 41_700,
        ...
        brandFloor: 50,
        qualityCeiling: 10,
        description: 'The industrial base a country would be proud of. There is nothing above this.',
    },
];
